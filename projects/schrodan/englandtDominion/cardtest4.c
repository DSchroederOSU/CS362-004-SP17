...
int testSalvager(struct gameState *state){
	...
	state->hand[whoseTurn(state)][0] = salvager; //make first card in hand a salvager 
	...
	int coinsOld = 6;//3 copper, 1 silver
...
int main(int argc, char *argv[]){
	printf("\n------------------------------\nSTARTING CARD TEST 4 ON SALVAGER\n\n");
	struct gameState G;
